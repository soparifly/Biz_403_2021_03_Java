...
public class App_05 {
	...
	public static void main(String[] args) {
		...
		//인스턴스 화 하는 코드
		//객체는 인스턴스가 되어야 포함된 코드 method를 호출할수있다
		...
		//객체를 생성하는 절차없이 method를 직접 호출할수 있다.
		//클래스.method()
		//static method 는 프로젝트가 시작됨과 동시에 자동으로 만들어져 언제든지 호출할수 있다.
		//다만, 지금 사용하지 않더라도 항상 메모리에 상주하고 있기때문에, 
