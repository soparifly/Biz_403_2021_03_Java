...
public static void main(String[] args) {
	...
	/*
	 * VO객체에 데이터를 저장하고 List 에 추가하려고하면 먼저 VO객체를 다시 생성해주어야한다.
	 */
	...
	//List의 toString()은 list가 포함하고 있는 데이터(ScoreVO) 의 전체 리스트의 데이터를 확인하는 용도로 재정의되있다.
	//이때 반드시 VO클래스의 toString()도 재정의 되어 있어야한다
