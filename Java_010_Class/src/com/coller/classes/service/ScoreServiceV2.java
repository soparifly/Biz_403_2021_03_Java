...
/*
 * ScoreServiceV1을 extends (상속, 확장) ScoreServiceV1에 있는 method를 그대로 이어받아서
 * ScoreServiceV2에 마치 복사 붙이기 한것처럼 사용하겠다.
 * V1에서 작성된  inputScore()를 V2에서는 새롭게 개선하겠다 (기능업그레이드) 
 * 
 */
public class ScoreServiceV2 extends ScoreServiceV1 {

	/*
	 * V1에서 protected로 지정된 변수는 V2에서 바로 사용 가능
	 */
	...
	public Integer inputScore(String strNum, String strSub) {
		...
		while (true) {
			...
			System.out.println(strNum + " 번의" + strSub + " 국어 점수를 입력하세요(중단: -1)");
